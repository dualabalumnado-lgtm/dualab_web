    ...
    <div v-if="!enviado">
      ...
      <form @submit.prevent="enviarFormulario" class="px-8 py-7 space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label class="block text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide mb-1.5">Sector</label>
            <input
              v-model="form.sector"
              type="text"
        ...
        <div class="bg-gradient-to-br from-green-50 to-emerald-50/60 dark:from-green-950/40 dark:to-emerald-950/20 rounded-2xl p-5 border border-green-100 dark:border-green-900/40">
          <div class="mb-3">
            <h3 class="text-sm font-bold text-gray-900 dark:text-gray-100 mb-0.5">
          ...
          <div class="flex flex-wrap gap-1.5 mb-3">
            <button
              ...
              class="px-2.5 py-1 bg-white dark:bg-gray-800 text-xs text-gray-500 dark:text-gray-400 rounded-full border border-gray-200 dark:border-gray-700 hover:border-brand-primary/60 hover:text-brand-dark dark:hover:text-brand-light hover:bg-white transition-all"
            >
              {{ hint }}
            </button>
          </div>
          ...
          <textarea
            ...
            class="w-full px-4 py-3.5 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 text-sm leading-relaxed focus:outline-none focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/10 transition-all resize-none"
          ></textarea>
        </div>
            ...
            <button
              ...
              :class="[
                ...
                form.plazo === opcion.value
                  ...
                  : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:border-brand-primary/50 hover:text-brand-dark dark:hover:text-brand-light hover:bg-green-50/50'
              ]"
            >
              {{ opcion.label }}
            </button>
